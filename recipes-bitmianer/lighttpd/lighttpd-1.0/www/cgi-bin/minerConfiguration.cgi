	...
	$.ajax({
		...
		success: function(data) {
			try
			{
				...
				$("#ant_apiallow").val(data.apiallow);
...
function f_submit_miner_conf() {
	...
	_ant_apiallow = $("#ant_apiallow").val();
	_ant_beeper = "true";
			...
			<div class="cbi-map" id="cbi-cgminer">
				...
				<fieldset class="cbi-section" id="cbi-cgminer-cgminer">
					...
					<fieldset class="cbi-section" id="cbi-cgminer-default">
						...
						<div class="cbi-value" id="cbi-cgminer-default-pool3pw">
					...
					<fieldset class="cbi-section" id="cbi-cgminer-default">
						<legend>Setup</legend>
						<div class="cbi-value cbi-value-last" id="cbi-cgminer-default-apiallow">
							<label class="cbi-value-title" for="cbid.cgminer.default.apiallow">API Allow</label>
							<div class="cbi-value-field">
